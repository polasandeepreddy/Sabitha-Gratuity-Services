...
import { Phone, Mail, MapPin, MessageCircle, Send, Clock, CheckCircle, Award } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              Contact us today for expert consultation and personalized solutions.
            </p>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-6 rounded-xl text-white">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Free initial consultation and requirement analysis</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="h-5 w-5 text-yellow-300 mt-0.5 flex-shrink-0" />
                    <span>Expert guidance from FIII qualified professionals</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="h-5 w-5 text-yellow-300 mt-0.5 flex-shrink-0" />
